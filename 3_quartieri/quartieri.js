...
let rotelle_selezionabili = Array.from(
  document.getElementsByClassName("wheel-selectable")
);
...
rotelle_selezionabili.forEach((wheel) => {
  wheel.addEventListener("click", () => {
    let isMobile = window.innerWidth < 991 ? true : false;

    if (!Array.from(wheel.classList).includes("wheel-selected")) {
      let carouselString = "";
      let imgEstention = wheel.getAttribute("id");
      switch (wheel.getAttribute("id")) {
      ...
      setQuartiere(wheel.getAttribute("id"));
      wheel.classList.add("wheel-selected");
      wheel.classList.remove("wheel-selectable");

      rotella_selezionata.classList.add("wheel-selectable");
      rotella_selezionata.classList.remove("wheel-selected");
...
content = {
  castello_goloso: ` <div class="event no-mobile castello-goloso">
  ...
  dolce_marea: `<div class="event no-mobile dolce-marea">
...
<div class="col-12 mt-3 d-flex justify-content-center">
  ...
  distretto_dorato: ` <div class="event no-mobile distretto-dorato">
...
<div class="event no-mobile foresta-incantata" id="carousel-event">
  <h2 class="subtitle center-subtitle">eventi foresta incantata</h2>
  <br />
  <div
    id="carousel-event-foresta-incantata"
    class="carousel slide"
    data-ride="carousel"
  >
    <ol class="carousel-indicators">
    ...
    <a
      class="carousel-control-prev"
      href="#carousel-event-foresta-incantata"
      role="button"
      data-slide="prev"
    >
      <span
